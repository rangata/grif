            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/notes') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Note Text</th><th>Good Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($note as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->note_text }}</td><td>{{ $item->good_id }}</td>
                                        <td>
