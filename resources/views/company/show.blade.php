                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Company Name </th><td> {{ $company->company_name }} </td></tr><tr><th> Company Address </th><td> {{ $company->company_address }} </td></tr><tr><th> Company Phone </th><td> {{ $company->company_phone }} </td></tr>
                                </tbody>
                            </table>
                        </div>
